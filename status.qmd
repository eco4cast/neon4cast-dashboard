...
Forecasts submitted over the last week: `r pheno_forecast_week`
Forecasts submitted over the last month: `r pheno_forecast_month`
Forecasts submitted over the last year: `r pheno_forecast_year`
...
theme_forecast_table(df_aquatics)
```
