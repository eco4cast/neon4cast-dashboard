...
```{r girafe, fig.width = 12, fig.height = 9}
ggob <- greenness_forecasts + score_by_horizon / score_by_time
girafe(ggobj = ggob, width_svg = 12, height_svg = 9,
  options = list(
...
### Redness {data-height=2000 data.width=500}
